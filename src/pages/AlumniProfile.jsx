      ...
      <div className="flex justify-center items-center min-h-screen bg-gray-100">
        <div className="text-center">
          ...
          <Link to="/discover" className="mt-4 inline-block text-blue-600 hover:underline">
            &larr; Go back to Discover to select a profile
          </Link>
        </div>
      </div>
    );
          ...
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
            ...
            <div className="p-8 bg-blue-50 border-b border-blue-100 flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6">
              ...
              <div className="text-center sm:text-left flex flex-col items-center sm:items-start space-y-2">
                ...
                <button
                  onClick={() => navigate('/chat', { state: { receiverId: userId } })}
                  className="mt-2 inline-flex items-center px-4 py-1.5 bg-purple-600 text-white text-sm font-semibold rounded-full shadow-sm hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-1 transition"
                >
                  Message
                </button>
              </div>
            ...
            <div className="p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <p>
                      <span className="font-medium text-gray-600">Occupation:</span> {user.current_job || 'Not specified'}
                    </p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <p>
                      <span className="font-medium text-gray-600">College:</span> {user.college}
                    </p>
                    <p>
                      <span className="font-medium text-gray-600">Department:</span> {user.department}
                    </p>
                    <p>
                      <span className="font-medium text-gray-600">Graduated:</span> {user.graduation_year}
                    </p>
                  </div>
                </div>
